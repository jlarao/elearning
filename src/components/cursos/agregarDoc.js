...
const AgregarDoc = ({ocultarFormAgregarDoc, idTema, maxFileUpload}) => {
  const cursosContext =  useContext(CursosContext);
  const { agregarHerramientaDocCurso } = cursosContext;
            ...
            if(datos.tema.urlHerramienta!== ""){
              //if(datos.tema.agregarVideo!== ""){
                setDatos({
                  ...
                  error: false,
                  errorMsg: ""})
                  agregarHerramientaDocCurso(datos.tema);
                  ocultarFormAgregarDoc(); 
        ...
        <object data={urlPdf} type="application/pdf" width="100%" height="100%">
              <p>Alternative text - include a link <a href={urlPdf}>to the PDF!</a></p>
                ...
                <div className="col-md-3 ml-auto">
                            ...
                            <button type="button" className="btn btn-danger" onClick={ocultarFormAgregarDoc}>Cancelar</button>
